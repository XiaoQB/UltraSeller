    ...
    <el-main>
      ...
      <el-dialog title="订单详情" :visible.sync="showDialog" width="45%">
        <el-form ref="tableData" :model="tableData[nowRow]" label-width="100px">
          ...
          <el-form-item label="商品图" prop="imgLink">
            <img
      ...
      <el-table :data="tableData" border stripe style="width: 100%">
        ...
        <el-table-column label="卖家名称" prop="name">
          <template slot-scope="scope">
            <el-input
              placeholder="请输入内容"
        ...
        <el-table-column label="商品图" prop="imgLink">
          <template slot-scope="scope">
  ...
  methods: {
    ...
    handleDelete(index, row) {
      this.http({
        headers: {
          token:
            "eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiJiYThlYmM2MC01MmQ1LTQ2NTctOTMzZi0zMWIzNGNkYjc4YTkiLCJzdWIiOiJ7XCJyb2xlXCI6XCJhZG1pblwiLFwic3VjY2Vzc1wiOlwiU1VDQ0VTU1wiLFwidXNlcm5hbWVcIjpcInhpYW9xdWFuYmluXCJ9IiwiaXNzIjoiYWRtaW4iLCJpYXQiOjE2MzUwNjA4NzcsImV4cCI6MTYzNTA2NDQ3N30.Yirgbn607G0W3cWwb74JJTZpJILlTudikQjnao1I0cc",
        },
        method: "delete",
