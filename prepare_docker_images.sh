...
docker buildx  build -t 75560/ultraseller-gateway:k8s-deploy --platform=linux/x86_64 ./us-gateway-service
...
docker buildx  build -t 75560/ultraseller-cart:k8s-deploy --platform=linux/x86_64  ./us-cart-service
...
docker push 75560/ultraseller-cart:k8s-deploy
